...
final class GroveTests: XCTestCase {
    ...
    func testDirectClassRegistration() {
        Grove.defaultContainer.register(initializer: NotProtocolConformingTestClass.init)
    ...
    func testClassAsProtocolRegistration() {
        Grove.defaultContainer.register(TestProtocol.self, initializer: TestClass.init)
    ...
    func testTransientScope() {
        Grove.defaultContainer.register(TestProtocol.self, scope: .transient, initializer: TestClass.init)
    ...
    func testSingletonScope() {
        Grove.defaultContainer.register(TestProtocol.self, scope: .singleton, initializer: TestClass.init)
